...
class SPPF(nn.Module, TTAMixin):
    """Spatial Pyramid Pooling - Fast (SPPF) layer with TTA support."""
    ...
    def forward(self, x):
        """Forward pass through SPPF with TTA support."""
        y = [self.cv1(x)]
...
class C2f(nn.Module, TTAMixin):
    """Faster Implementation of CSP Bottleneck with 2 convolutions."""

    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        """Initialize CSP Bottleneck with 2 convolutions and n Bottleneck layers."""
        super().__init__()
        self.c = int(c2 * e)  # hidden channels
        self.cv1 = Conv(c1, 2 * self.c, 1, 1)
...
class Bottleneck(nn.Module, TTAMixin):
    """Standard bottleneck."""

    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        """Initialize bottleneck module with specified channels, shortcut option and expansion ratio."""
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
    ...
    def forward(self, x):
        """Forward pass through bottleneck with TTA support."""
...
class ABlock(nn.Module, TTAMixin):
    """
    ...
    def __init__(self, dim, num_heads, mlp_ratio=1.2, area=1):
        ...
        # Initialize TTA adaptor
        self._init_tta(out_channels=dim)
